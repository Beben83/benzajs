...
function setTHttpClient(options) {
    var connection =
      thrift.createHttpConnection('legy-gslb.line.naver.jp', 443, options);
...
setTHttpClient(options={
    ...
    headers: {'User-Agent':'Line/10.1.1','X-Line-Application':'CHANNELCP\t2.9.1\tAndroid OS\t5.1.1','X-Line-Access':token},
    path: '/S4',
    https: true
    });
